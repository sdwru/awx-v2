...
class FloatingIpSpec extends \PhpSpec\ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('AwxV2\Api\FloatingIp');
    }
    ...
    public function it_returns_an_array_of_floating_ip_entity($adapter)
    {
        ...
        foreach ($ips as $ip) {
            /**
             * @var \AwxV2\Entity\FloatingIp|\PhpSpec\Wrapper\Subject $ip
             */
            $ip->shouldReturnAnInstanceOf('AwxV2\Entity\FloatingIp');
        }
        $meta = $this->getMeta();
    ...
    public function it_returns_a_floating_ip_entity_get_by_its_id($adapter)
    {
        ...
        $ip->region->shouldReturnAnInstanceOf('AwxV2\Entity\Region');
    ...
    public function it_returns_the_created_floating_id_entity_assigned_to_droplet($adapter)
    {
        ...
        $this->createAssigned(123456)->shouldReturnAnInstanceOf('AwxV2\Entity\FloatingIp');
    }
    ...
    public function it_returns_the_created_floating_id_entity_reserved_by_region($adapter)
    {
        ...
        $this->createReserved('nyc3')->shouldReturnAnInstanceOf('AwxV2\Entity\FloatingIp');
    }
