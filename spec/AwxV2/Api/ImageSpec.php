...
class ImageSpec extends \PhpSpec\ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('AwxV2\Api\Image');
    }
    ...
    public function it_returns_an_array_of_image_entity($adapter)
    {
        ...
        foreach ($images as $image) {
            /**
             * @var \AwxV2\Entity\Image|\PhpSpec\Wrapper\Subject $image
             */
            $image->shouldReturnAnInstanceOf('AwxV2\Entity\Image');
        }
        $meta = $this->getMeta();
    ...
    public function it_returns_an_image_entity_get_by_its_slug($adapter)
    {
        ...
        $this->getBySlug('foo-bar')->shouldReturnAnInstanceOf('AwxV2\Entity\Image');
    }
    ...
    public function it_returns_the_updated_image($adapter)
    {
        ...
        $this->update(123, 'bar-baz')->shouldReturnAnInstanceOf('AwxV2\Entity\Image');
    }
    ...
    public function it_transfer_the_image_to_an_other_region_and_returns_its_image($adapter)
    {
        ...
        $image->shouldReturnAnInstanceOf('AwxV2\Entity\Action');
        $image->region->shouldReturnAnInstanceOf('AwxV2\Entity\Region');
    }
