...
class VolumeSpec extends \PhpSpec\ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('AwxV2\Api\Volume');
    }
...
EOT;
        ...
        /**
         * @var \AwxV2\Entity\Volume|\PhpSpec\Wrapper\Subject $volume
         */
        $volume = $volumes[0];
        $volume->shouldReturnAnInstanceOf('AwxV2\Entity\Volume');
        $volume->region->shouldReturnAnInstanceOf('AwxV2\Entity\Region');
...
EOT;
        ...
        foreach ($snapshots as $snapshot) {
            /**
             * @var \AwxV2\Entity\Snapshot|\PhpSpec\Wrapper\Subject $snapshot
             */
            $snapshot->shouldReturnAnInstanceOf('AwxV2\Entity\Snapshot');
        }
        $meta = $this->getMeta();
        $meta->shouldBeAnInstanceOf('AwxV2\Entity\Meta');
        $meta->total->shouldBe($total);
...
EOT;
        ...
        $snapshot->shouldBeAnInstanceOf('AwxV2\Entity\Snapshot');
