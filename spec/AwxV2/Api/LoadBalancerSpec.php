...
class LoadBalancerSpec extends \PhpSpec\ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('AwxV2\Api\LoadBalancer');
    }
    ...
    public function it_returns_an_array_of_load_balancer_entity($adapter)
    {
        ...
        foreach ($loadBalancers as $loadBalancer) {
            /**
             * @var \AwxV2\Entity\LoadBalancer|\PhpSpec\Wrapper\Subject $loadBalancer
             */
            $loadBalancer->shouldReturnAnInstanceOf('AwxV2\Entity\LoadBalancer');
        }
    ...
    public function it_returns_a_load_balancer_entity_by_its_id($adapter)
    {
        ...
        $loadBalancer->shouldBeAnInstanceOf('AwxV2\Entity\LoadBalancer');
    }
