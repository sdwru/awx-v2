...
class KeySpec extends \PhpSpec\ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('AwxV2\Api\Key');
    }
    ...
    function it_returns_an_array_of_key_entity($adapter)
    {
        ...
        foreach ($keys as $key) {
            /**
             * @var \AwxV2\Entity\Key|\PhpSpec\Wrapper\Subject $key
             */
            $key->shouldReturnAnInstanceOf('AwxV2\Entity\Key');
        }
        $meta = $this->getMeta();
    ...
    function it_returns_a_key_entity_get_by_its_id($adapter)
    {
        ...
        $this->getById(123)->shouldReturnAnInstanceOf('AwxV2\Entity\Key');
    }
    ...
    function it_returns_a_key_entity_get_by_its_fingerprint($adapter)
    {
        ...
        $this
            ...
            ->shouldReturnAnInstanceOf('AwxV2\Entity\Key');
    }
    ...
    function it_returns_the_created_key($adapter)
    {
        ...
        $this->create('foo', 'ssh-rsa foobarbaz...')->shouldReturnAnInstanceOf('AwxV2\Entity\Key');
    }
    ...
    function it_returns_the_updated_key($adapter)
    {
        ...
        $this->update(456, 'bar')->shouldReturnAnInstanceOf('AwxV2\Entity\Key');
    }
