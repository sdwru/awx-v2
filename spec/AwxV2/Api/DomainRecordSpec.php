...
use AwxV2\Exception\InvalidRecordException;
...
class DomainRecordSpec extends \PhpSpec\ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('AwxV2\Api\DomainRecord');
    }
    ...
    function it_returns_an_array_of_domain_record_entity($adapter)
    {
        ...
        foreach ($domainRecords as $domainRecord) {
            /**
             * @var \AwxV2\Entity\DomainRecord|\PhpSpec\Wrapper\Subject $domainRecord
             */
            $domainRecord->shouldReturnAnInstanceOf('AwxV2\Entity\DomainRecord');
        }
        $meta = $this->getMeta();
    ...
    function it_returns_the_domain_get_by_its_id($adapter)
    {
        ...
        $this->getById('foo.dk', 123)->shouldReturnAnInstanceOf('AwxV2\Entity\DomainRecord');
    ...
    function it_returns_the_created_domain_record_type_a($adapter)
    {
        ...
        $this->create('foo.dk', 'a', '@', '8.8.8.8')->shouldReturnAnInstanceOf('AwxV2\Entity\DomainRecord');
    }
    ...
    function it_returns_the_created_domain_record_type_aaaa($adapter)
    {
        ...
        $this
            ...
            ->shouldReturnAnInstanceOf('AwxV2\Entity\DomainRecord');
    }
    ...
    function it_returns_the_created_domain_record_with_ttl($adapter)
    {
        ...
        $this->create('foo.dk', 'a', '@', '8.8.8.8', null, null, null, null, null, 60)->shouldReturnAnInstanceOf('AwxV2\Entity\DomainRecord');
    }
