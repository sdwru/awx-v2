...
class DropletSpec extends \PhpSpec\ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('AwxV2\Api\Droplet');
    }
    ...
    public function it_returns_an_array_of_droplet_entity($adapter)
    {
        ...
        foreach ($droplets as $droplet) {
            /**
             * @var \AwxV2\Entity\Droplet|\PhpSpec\Wrapper\Subject $droplet
             */
            $droplet->shouldReturnAnInstanceOf('AwxV2\Entity\Droplet');
        }
        $meta = $this->getMeta();
    ...
    public function it_returns_an_array_of_upgrade_entity($adapter)
    {
        ...
        foreach ($upgrades as $upgrade) {
            /**
             * @var \AwxV2\Entity\Upgrade|\PhpSpec\Wrapper\Subject $upgrade
             */
            $upgrade->shouldReturnAnInstanceOf('AwxV2\Entity\Upgrade');
        }
    }
    ...
    public function it_returns_an_array_of_droplet_that_are_running_on_the_same_physical_hardware($adapter)
    {
        ...
        foreach ($neighbors as $neighbor) {
            /**
             * @var \AwxV2\Entity\Droplet|\PhpSpec\Wrapper\Subject $neighbor
             */
            $neighbor->shouldReturnAnInstanceOf('AwxV2\Entity\Droplet');
        }
    }
    ...
    public function it_returns_a_droplet_entity_get_by_its_id($adapter)
    {
        ...
        foreach ($droplet->networks as $dropletNetwork) {
            /**
             * @var \AwxV2\Entity\Network|\PhpSpec\Wrapper\Subject $dropletNetwork
             */
            $dropletNetwork->shouldReturnAnInstanceOf('AwxV2\Entity\Network');
        }

        $droplet->kernel->shouldReturnAnInstanceOf('AwxV2\Entity\Kernel');
        $droplet->region->shouldReturnAnInstanceOf('AwxV2\Entity\Region');
        $droplet->image->shouldReturnAnInstanceOf('AwxV2\Entity\Image');
        ...
        $droplet->nextBackupWindow->shouldReturnAnInstanceOf('AwxV2\Entity\NextBackupWindow');
    }
    ...
    public function it_returns_the_created_droplet_entity_without_ssh_keys($adapter)
    {
        ...
        $this->create('foo', 'nyc1', '512mb', 123456, false, false, false, [], '', true, ['123', '456'], ['foo', 'bar'])->shouldReturnAnInstanceOf('AwxV2\Entity\Droplet');
    }
    ...
    public function it_returns_the_created_droplet_entity_with_ssh_keys($adapter)
    {
        ...
        $this
            ...
            ->shouldReturnAnInstanceOf('AwxV2\Entity\Droplet');
    }
    ...
    public function it_returns_an_array_of_droplets_kernel_entity($adapter)
    {
        ...
        foreach ($kernels as $kernel) {
            /**
             * @var \AwxV2\Entity\Kernel|\PhpSpec\Wrapper\Subject $kernel
             */
            $kernel->shouldReturnAnInstanceOf('AwxV2\Entity\Kernel');
        }
        $meta = $this->getMeta();
        $meta->shouldBeAnInstanceOf('AwxV2\Entity\Meta');
        $meta->total->shouldBe($total);
    ...
    public function it_returns_an_array_of_droplets_snapshots_which_are_image_entity($adapter)
    {
        ...
        foreach ($snapshots as $snapshot) {
            /**
             * @var \AwxV2\Entity\Image|\PhpSpec\Wrapper\Subject $snapshot
             */
            $snapshot->shouldReturnAnInstanceOf('AwxV2\Entity\Image');
        }
        $meta = $this->getMeta();
        $meta->shouldBeAnInstanceOf('AwxV2\Entity\Meta');
        $meta->total->shouldBe($total);
    ...
    public function it_returns_an_array_of_droplets_backup_which_are_image_entity($adapter)
    {
        ...
        foreach ($backups as $backup) {
            /**
             * @var \AwxV2\Entity\Image|\PhpSpec\Wrapper\Subject $backup
             */
            $backup->shouldReturnAnInstanceOf('AwxV2\Entity\Image');
        }
        $meta = $this->getMeta();
        $meta->shouldBeAnInstanceOf('AwxV2\Entity\Meta');
        $meta->total->shouldBe($total);
