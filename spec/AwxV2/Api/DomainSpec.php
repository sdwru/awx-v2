...
class DomainSpec extends \PhpSpec\ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('AwxV2\Api\Domain');
    }
    ...
    function it_returns_an_array_of_domain_entity($adapter)
    {
        ...
        foreach ($domains as $domain) {
            /**
             * @var \AwxV2\Entity\Domain|\PhpSpec\Wrapper\Subject $domain
             */
            $domain->shouldReturnAnInstanceOf('AwxV2\Entity\Domain');
        }
        $meta = $this->getMeta();
    ...
    function it_returns_a_domain_entity_get_by_its_name($adapter)
    {
        ...
        $this->getByName('foo.com')->shouldReturnAnInstanceOf('AwxV2\Entity\Domain');
    }
    ...
    function it_returns_the_created_domain_entity($adapter)
    {
        ...
        $this->create('bar.dk', '127.0.0.1')->shouldReturnAnInstanceOf('AwxV2\Entity\Domain');
    }
